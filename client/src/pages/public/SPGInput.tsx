...
const SPGInput: React.FC = () => {
    ...
    const handleOutlet = (e: any, index: number) => {
        console.log(e)
        let dataOutlet = outlets.find((item) => item.outlet.id === e.value)
        setOutlet(prevOutlets =>
            prevOutlets.map((outlet, i) =>
    ...
    return (
        <div className="rounded-md min-h-screen flex items-center justify-center mt-12">
            <div className="bg-[#AFAFAF] rounded-3xl shadow-lg p-5 w-96 pb-[75px] mt-10">
                ...
                <h2 className="text-xl font-bold mb-4 text-center">INPUT DATA SPG</h2>
                <form>
                    <div className="mb-4">
                                ...
                                <div key={index}>
                                    <div className="mb-4">
                                        ...
                                        <SearchSelectInput
                                            ...
                                            options={outlets.map((item: any) => ({ label: item.outlet.name, value: item.outlet.id }))}
